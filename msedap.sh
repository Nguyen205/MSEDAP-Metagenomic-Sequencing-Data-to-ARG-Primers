...
usage() {
    ...
    echo ""
    echo " -1 FILE    Query input txt file containing all single-read fastq file paths. (-1 and -2 are incompatible)"
    echo " -2 FILE    Query input txt file containing all paired-read fastq file paths. (-1 and -2 are incompatible)"
